...
Similarly to traditional convolutional-networks, training is done by simple SGD on a negative-log-likelihood loss with regard to the 2-class problem. We later examined that better results are achieved when the loss function is replaced by a simple MSE on the soft-max result, compared to the $(0,1)$ vector, so that the loss is 
...
\begin{figure}[h]
    ...
    Mnist & 99.54\% & 98.14\%& 99.61\% \citet{mairal2014convolutional,lee2014deeply}  \\ \hline
